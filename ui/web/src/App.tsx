          ...
          <Card title="GPU & Monitors">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
              <div className="flex items-center gap-2 min-w-0 overflow-hidden">
                ...
                <select className="rounded px-2 py-1 flex-1 min-w-0 w-full max-w-full truncate" style={{ color: accentText }} value={st.gpuName} onChange={e=>setSt({...st, gpuName:e.target.value})}>
